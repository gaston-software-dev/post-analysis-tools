...
<pre class="color: #2ECCFA; font-size:18px;"> <span style="color:red;">python</span> ihppinbuilder.py -r resources -o outputfolder -i outputProtID -f outputfileformat </pre>
