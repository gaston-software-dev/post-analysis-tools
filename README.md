...
<pre class="color: #CEECF5; font-size:18px;"> <span style="color:red;">python</span> ihppinbuilder.py -r resources -o outputfolder -i outputProtID -f outputfileformat </pre>
