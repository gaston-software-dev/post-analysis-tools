...
<p class="background-color: #CEECF5;"> <span style="color:red">python</span> `ihppinbuilder.py` `-r` _resources_ `-o` _outputfolder_ `-i` _outputProtID_ `-f` _outputfileformat_ </p>
