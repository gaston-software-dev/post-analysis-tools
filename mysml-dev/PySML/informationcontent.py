...
class InformationContent(object):
	...
	_ontofile = "/home/user/SADaCC-SPARCoProject/go-basic.obo"
	_namespace = 'biological_process'
	AppMods = {'universal':'GOuniversal', 'wang':'processWang', 'zhang':'processZhang', 'seco':'processSeco', 'zho':'processZho', 'seddiqui':'processSeddiqui', 'zanchez': 'processZanchez', 'meng': 'processMeng', 'stats': 'processStats', 'ic':'virtualIC', 'assdd': 'processSSDD'}
	...
	def getIC(self, approach = None, TermList = None, **kwargs):
		...
		if TermList is not None: # Selected IC scores for terms in the list
			...
			self.TargetTerms = dict([(self.Dag[j], j) for j in range(len(self.Dag))])
