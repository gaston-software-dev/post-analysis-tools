...
from PySML.smlapps import EntityIdentification

if __name__=='__main__':
	idt = EntityIdentification()
	...
	targets = ['GO:0006355', 'GO:001905', 'GO:0001658', 'GO:0006120']
	
	idt.retrieveEntity(background, targets, ('nunivers','universal'))
